...
/**
 * Created by theone on 1/25/16.
 * Another settings activity that extends AppcompatActivity instead
 * of PreferencesActivity. According to Android documentation, since
 * we're using a PreferenceFragment for out settings, we can use any
 * activity. This might make it easier to set up an ActionBar
 */
